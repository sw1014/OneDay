...
@interface addDiaryMoodViewController ()
...
@implementation addDiaryMoodViewController
...
- (void)viewDidLoad {
    ...
    [_moodbtn1 setImage:[UIImage imageNamed:@"开心1"] forState:UIControlStateNormal];
    [_moodbtn1 setImage:[UIImage imageNamed:@"开心2"] forState:UIControlStateSelected];
    ...
    [_moodbtn2 setImage:[UIImage imageNamed:@"惊喜1"] forState:UIControlStateNormal];
    [_moodbtn2 setImage:[UIImage imageNamed:@"惊喜2"] forState:UIControlStateSelected];
    ...
    [_moodbtn3 setImage:[UIImage imageNamed:@"佛系1"] forState:UIControlStateNormal];
    [_moodbtn3 setImage:[UIImage imageNamed:@"佛系2"] forState:UIControlStateSelected];
    ...
    [_moodbtn4 setImage:[UIImage imageNamed:@"迷茫1"] forState:UIControlStateNormal];
    [_moodbtn4 setImage:[UIImage imageNamed:@"迷茫2"] forState:UIControlStateSelected];
    ...
    [_moodbtn5 setImage:[UIImage imageNamed:@"烦躁1"] forState:UIControlStateNormal];
    [_moodbtn5 setImage:[UIImage imageNamed:@"烦躁2"] forState:UIControlStateSelected];
    ...
    [_moodbtn6 setImage:[UIImage imageNamed:@"生气1"] forState:UIControlStateNormal];
    [_moodbtn6 setImage:[UIImage imageNamed:@"生气2"] forState:UIControlStateSelected];
...
-(void)selectmood
{
    addDiaryEventViewController *vc=[[addDiaryEventViewController alloc]init];
